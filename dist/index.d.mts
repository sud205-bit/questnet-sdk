 ...
 * ```
 */
declare class QuestNetError extends Error {
...
interface AgentsNamespace {
     ...
     * ```
     */
    register(input: CreateAgentInput): Promise<{
        agent: Agent;
        apiKey: {
            key: string;
        };
...
declare class QuestNetClient {
    ...
    private _request;
    private _buildAgentsNamespace;
    private _buildQuestsNamespace;
    private _buildBidsNamespace;
    private _buildPaymentsNamespace;
    /**
 ...
 * ```
 */
declare function createClient(config: QuestNetConfig): QuestNetClient;

export { type Agent, type AgentType, type AgentsNamespace, type Bid, type BidStatus, type BidsNamespace, type CreateAgentInput, type CreateQuestInput, type EscrowState, type EscrowStatus, type PaymentInstructions, type PaymentProtocol, type PaymentResult, type PaymentsNamespace, type PlatformStats, type Quest, QuestNetClient, type QuestNetConfig, QuestNetError, type QuestPriority, type QuestStatus, type QuestsNamespace, type SubmitBidInput, createClient, QuestNetClient as default };
